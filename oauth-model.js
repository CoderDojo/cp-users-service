...
model.getAccessToken = function (bearerToken, callback) {
    pg.connect(connString, function (err, client, done) {
        ...
        var query = 'SELECT access_token, client_id, expires, user_id FROM oauth_access_tokens ' +
    ...
    pg.connect(connString, function(err, client, done){
        ...
        client.query(query, [], function(err, result){
            ...
            var returnValue = {
                ...
                // userId isn't used outside of here, this would only need implementation if this was working w/o NodeBB
                , userId: JSON.parse(result.rows[0].user_id) // grant takes two types, user = {id: 'uuid'}, or userId //result.rows[0].user_id
