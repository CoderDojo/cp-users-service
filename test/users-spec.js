  ...
  lab.experiment('Register', function(){
    lab.test('save user to db', function(done){
      ...
      var user = {
        ...
        "g-recaptcha-response": "03AOPBWq_zZcFSVHCL3zH0t7SThH22MZFcsBmpzXEnUdou5ZalprQmaDDQZBMlWy4fkE9wOlg3GdGVgEmfU26ST_4YliV2RbXKO0oLGcTjmozmMgP7RxX6No6vQ7mGU3CAEYmcIxCAWkrC2E_-DEUmTIlZaMNwbBiaEWjneqyUe47LcpH3OIKGacdbGBmvQjsGHzE73cWvRoMb4x_wTFZ-7-nTN7-txyOZWfnkO-CXovtjD4w14BQ2d8H46Ll1N_0ZFMPGXdH_FFRjo7NJvG83mQ2ZNitnBvklt9q_BIDtGOFvOK3yW4N2KFE"
      }
      var args = {
        "user": user,
        "profile": profiles
